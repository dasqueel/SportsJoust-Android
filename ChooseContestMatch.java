...
public class ChooseContestMatch extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        nfl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Log.i("nflStr",nflContest);
                Intent i = new Intent(ChooseContestMatch.this, Match.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.home:
                // location found
                Intent i = new Intent(ChooseContestMatch.this, Home.class);
                startActivity(i);
                return true;
            case R.id.logOut:
                // location found
                ...
                Intent logOutI = new Intent(ChooseContestMatch.this, MainActivity.class);
