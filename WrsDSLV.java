...
public class WrsDSLV extends ActionBarActivity implements RemoveModeDialog.RemoveOkListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wrs);

        Toast.makeText(getApplicationContext(), "Rank top 10 WRs", Toast.LENGTH_LONG).show();
        ...
        toRbs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent rbIntent = new Intent(WrsDSLV.this, RbsDSLV.class);
        ...
        toTes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                setNewRank(pos,newOrder,mtoken,contest);
                Intent teIntent = new Intent(WrsDSLV.this, TesDSLV.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.home:
                // location found
                Intent i = new Intent(WrsDSLV.this, Home.class);
                startActivity(i);
                return true;
            case R.id.logOut:
                // location found
                ...
                Intent logOutI = new Intent(WrsDSLV.this, MainActivity.class);
