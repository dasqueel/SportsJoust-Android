...
public class RbsDSLV extends ActionBarActivity implements RemoveModeDialog.RemoveOkListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rbs);

        Toast.makeText(getApplicationContext(), "Rank top 10 RBs", Toast.LENGTH_LONG).show();
        ...
        toQbs = (TextView)findViewById(R.id.toQbs);
        toWrs = (TextView)findViewById(R.id.toWrs);

        FragmentManager fm = getSupportFragmentManager();
        if (fm.findFragmentByTag(TAG_DSLV_FRAGMENT) == null) {
            fm.beginTransaction()
                    .add(R.id.test_bed, getNewRbfrag(), TAG_DSLV_FRAGMENT)
                    .commit();
        }

        toQbs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Log.i("checkit",contest);
                setNewRank(pos,newOrder,mtoken,contest);

                Intent rbIntent = new Intent(RbsDSLV.this, QbsDSLV.class);
                rbIntent.putExtra("contest", contest);
                startActivity(rbIntent);
            }
        });

        toWrs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Intent rbIntent = new Intent(RbsDSLV.this, WrsDSLV.class);
                rbIntent.putExtra("contest", contest);
                startActivity(rbIntent);
            }
        });
    ...
    public void onRemoveOkClick(int removeMode) {
        if (removeMode != mRemoveMode) {
            ...
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.test_bed, getNewRbfrag(), TAG_DSLV_FRAGMENT)
                    .commit();
        }
    }
    ...
    public void onDragOkClick(int dragStartMode) {
        ...
        Rbfrag f =
                (Rbfrag) getSupportFragmentManager().findFragmentByTag(TAG_DSLV_FRAGMENT);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.home:
                // location found
                Intent i = new Intent(RbsDSLV.this, Home.class);
                startActivity(i);
                return true;
            case R.id.logOut:
                // location found
                ...
                Intent logOutI = new Intent(RbsDSLV.this, MainActivity.class);
