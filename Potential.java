...
public class Potential extends ActionBarActivity {
    ListView listView;
    //String mtoken = "abc123";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.potential);
        ...
        final List<String> turnList = new ArrayList<String>();

        String url = "http://52.24.226.232/mgetPotential?mtoken="+mtoken;
        try {
            ...
            JSONArray turnListJson = json.getJSONArray("turnList");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(getApplicationContext(), WagerBarter.class);
                i.putExtra("matchId", matchIds.get(position));
                i.putExtra("contest", contestList.get(position));
                i.putExtra("turn", turnList.get(position));
                startActivity(i);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.home:
                // location found
                Intent i = new Intent(Potential.this, Home.class);
                startActivity(i);
                return true;
            case R.id.logOut:
                // location found
                ...
                Intent logOutI = new Intent(Potential.this, MainActivity.class);
