...
public class Wager extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sendWager.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                postWager("http://52.24.226.232/msetWager", "nfl1",mtoken,matchId,wage);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.home:
                // location found
                Intent i = new Intent(Wager.this, Home.class);
                startActivity(i);
                return true;
            case R.id.logOut:
                // location found
                ...
                Intent logOutI = new Intent(Wager.this, MainActivity.class);
