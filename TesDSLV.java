...
public class TesDSLV extends ActionBarActivity implements RemoveModeDialog.RemoveOkListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(getApplicationContext(), "Rank top 5 TEs", Toast.LENGTH_LONG).show();
        ...
        toDefs = (TextView)findViewById(R.id.toDefs);
        ...
        toDefs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Intent defIntent = new Intent(TesDSLV.this, DefsDSLV.class);
                defIntent.putExtra("contest", contest);
        ...
        toWrs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                setNewRank(pos,newOrder,mtoken,contest);
                Intent wrIntent = new Intent(TesDSLV.this, WrsDSLV.class);
                wrIntent.putExtra("contest", contest);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.home:
                // location found
                Intent i = new Intent(TesDSLV.this, Home.class);
                startActivity(i);
                return true;
            case R.id.logOut:
                // location found
                ...
                Intent logOutI = new Intent(TesDSLV.this, MainActivity.class);
